...
import { Plus, Minus, ArrowLeft, Truck } from 'lucide-react';
        ...
        <div className="flex flex-col gap-4 border-b border-indigo-500/30 pb-6 relative">
          ...
          <div>
            <h1 className="text-4xl font-light text-white tracking-tight mb-1">
              NEW <span className="font-bold text-cyan-400">DELIVERY</span>
            </h1>
            <p className="text-sm text-indigo-200 tracking-wider uppercase">
              Create a new outgoing stock operation
            </p>
          </div>
        </div>
          ...
          <div className="card p-6 rounded-xl bg-slate-900 border border-slate-800">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Basic details about the delivery</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="contact" className="text-slate-300">Customer Contact *</Label>
                  <Input
                    id="contact"
